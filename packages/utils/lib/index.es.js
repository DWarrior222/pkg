...
function getTopics() {
    return __awaiter(this, void 0, Promise, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, axios.get('https://cnodejs.org/api/v1/topics')];
...
export { arrayIncludes, budget, gen, getTopics, optionalOperator, promiseAny, replaceAll, sum, testClass };
